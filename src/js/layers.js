  ...
  function drawBackground(context, camera) {
    ...
    for (let i = 0; i < 30; i++) {
      if (GlassBackImage) {
        context.drawImage(
          GlassBackImage,
          GlassCoordX + BackgroundImage.width * i + 600,
          buffer.height - GlassBackImage.height + 1,
        );
      }
      context.drawImage(
        BackgroundImage,
        BackgroundCoordX + BackgroundImage.width * i,
        buffer.height - BackgroundImage.height + 1,
      );
      if (GlassFrontImage) {
        context.drawImage(
          GlassFrontImage,
          GlassCoordX + BackgroundImage.width * i + 100,
